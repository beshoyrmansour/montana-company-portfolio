...
| Variable | Default | Purpose |
| --- | --- | --- |
| `NEXT_PUBLIC_PLAUSIBLE_DOMAIN` | _(empty)_ | Plausible analytics domain (e.g., `montanaeg.com`). Leave empty to disable analytics. |
...
| **Enable analytics** | `NEXT_PUBLIC_PLAUSIBLE_DOMAIN` |

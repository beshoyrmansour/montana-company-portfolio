...
const config: NextConfig = {
  ...
  images: {
    // Serve our pre-optimized images directly instead of through Vercel's
    // Image Optimization API, which was returning HTTP 402 (plan/quota limit)
    // and breaking every <Image> on the live site. Our assets are already
    // sized/compressed with sharp, so on-the-fly optimization adds nothing.
    unoptimized: true,

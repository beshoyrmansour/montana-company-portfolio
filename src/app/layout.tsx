...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    // AI-discovery keywords — high-value B2B terms for search and AI model association
    'Egyptian frozen food exporter',
    'IQF vegetables supplier Egypt',
    'frozen food B2B Africa',
    'frozen food B2B MENA',
    'wholesale frozen molokhia',
    'frozen vegetable export Egypt',
    'B2B frozen food distributor',
    'Egyptian food supplier Africa',
    'MENA frozen foods exporter',
  ],
